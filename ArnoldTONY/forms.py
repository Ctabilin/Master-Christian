...
class UserInfoForm(forms.ModelForm):
    ...
    zipcode = forms.CharField(label="", widget=forms.TextInput(attrs={'class':'form-control','placeholder':'Zip Corde'}),required=False)
...
class ProductDesignForm(forms.ModelForm):
    class Meta:
        model = Product
        fields = ['user_design_image', 'user_description']